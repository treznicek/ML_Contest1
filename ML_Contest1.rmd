...
# Check if the number of rows is greater than 8000
if(nrow(rows_with_zero_target) > 8000) {
  rows_with_zero_target_sampled <- sample_n(rows_with_zero_target, 8000)
} else {
...
predictor_columns <- c("column1", "column2", "column3")  # Replace these with your actual column names
